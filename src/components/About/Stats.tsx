...
export function Stats() {
  const stats = [
    { icon: <Code size={20} />, number: "5+", label: "Years Experience", delay: 0 },
    { icon: <Briefcase size={20} />, number: "50+", label: "Projects Completed", delay: 0.1 },
    { icon: <Users size={20} />, number: "30+", label: "Happy Clients", delay: 0.2 },
