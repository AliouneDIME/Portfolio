...
const CERTS: Cert[] = [
  {
    ...
    pdfFile: '/certificates/Certifiation Coursera.pdf',
  ...
  },
  {
    ...
    pdfFile: '/certificates/Certificat Analyste Cybersécurité.pdf',
  ...
  },
  {
    ...
    pdfFile: '/certificates/Certificat Commerce Digitale.pdf',
  ...
  },
  {
    ...
    pdfFile: '/certificates/Certificat Getting Started with Devops on AWS.pdf',
  ...
  },
  {
    ...
    pdfFile: '/certificates/Certification Mastering Docker Containers, Networking, and Orchestration.pdf',
  ...
  },
  {
    ...
    pdfFile: '/certificates/Git Version Control for Beginners.pdf',
